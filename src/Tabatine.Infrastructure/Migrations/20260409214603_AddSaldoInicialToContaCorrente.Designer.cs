...
namespace Tabatine.Infrastructure.Migrations
{
    ...
    [Migration("20260409214603_AddSaldoInicialToContaCorrente")]
    partial class AddSaldoInicialToContaCorrente
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Tabatine.Core.Entities.TituloPagar", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_titulos_pagar");

                    b.HasIndex("ClienteId")
                        .HasDatabaseName("ix_titulos_pagar_cliente_id");

                    b.HasIndex("ContaCorrenteId")
                        .HasDatabaseName("ix_titulos_pagar_conta_corrente_id");

                    b.HasIndex("DataVencimento")
                        .HasDatabaseName("ix_titulos_pagar_data_vencimento");

                    b.HasIndex("OmieId")
                        .IsUnique()
                        .HasDatabaseName("ix_titulos_pagar_omie_id");

                    b.HasIndex("StatusTitulo")
                        .HasDatabaseName("ix_titulos_pagar_status_titulo");

                    b.ToTable("titulos_pagar", (string)null);
                });

            modelBuilder.Entity("Tabatine.Core.Entities.TituloReceber", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_titulos_receber");

                    b.HasIndex("ClienteId")
                        .HasDatabaseName("ix_titulos_receber_cliente_id");

                    b.HasIndex("ContaCorrenteId")
                        .HasDatabaseName("ix_titulos_receber_conta_corrente_id");

                    b.HasIndex("DataVencimento")
                        .HasDatabaseName("ix_titulos_receber_data_vencimento");

                    b.HasIndex("OmieId")
                        .IsUnique()
                        .HasDatabaseName("ix_titulos_receber_omie_id");

                    b.HasIndex("StatusTitulo")
                        .HasDatabaseName("ix_titulos_receber_status_titulo");

                    b.HasIndex("VendedorId")
                        .HasDatabaseName("ix_titulos_receber_vendedor_id");

                    b.ToTable("titulos_receber", (string)null);
                });
            ...
            modelBuilder.Entity("Tabatine.Core.Entities.TituloPagar", b =>
                {
                    b.HasOne("Tabatine.Core.Entities.Cliente", "Cliente")
                        ...
                        .HasForeignKey("ClienteId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_titulos_pagar_clientes_cliente_id");

                    b.HasOne("Tabatine.Core.Entities.ContaCorrente", "ContaCorrente")
                        .WithMany()
                        .HasForeignKey("ContaCorrenteId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_titulos_pagar_contas_corrente_conta_corrente_id");
            ...
            modelBuilder.Entity("Tabatine.Core.Entities.TituloReceber", b =>
                {
                    b.HasOne("Tabatine.Core.Entities.Cliente", "Cliente")
                        ...
                        .HasForeignKey("ClienteId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_titulos_receber_clientes_cliente_id");

                    b.HasOne("Tabatine.Core.Entities.ContaCorrente", "ContaCorrente")
                        .WithMany()
                        .HasForeignKey("ContaCorrenteId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_titulos_receber_contas_corrente_conta_corrente_id");

                    b.HasOne("Tabatine.Core.Entities.Vendedor", "Vendedor")
                        .WithMany()
                        .HasForeignKey("VendedorId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_titulos_receber_vendedores_vendedor_id");
