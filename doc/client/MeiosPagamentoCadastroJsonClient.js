...
var MeiosPagamentoCadastroJsonClient=function(){
	this._EndPoint="https://app.omie.com.br/api/v1/geral/meiospagamento/";
	...
	this.ListarMeiosPagamento=function(
	...
	this.MeiosPagamentoLista=function(){
		this.codigo=null;
		this.descricao=null;
	};
	this.MeiosPagamentoPesquisarRequest=function(){
		this.codigo=null;
	};
	this.MeiosPagamentoPesquisarResponse=function(){
		this.MeiosPagamentoLista=null;
	};
...
module.exports = MeiosPagamentoCadastroJsonClient;