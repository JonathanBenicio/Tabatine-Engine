...
var FormasPagVendasJsonClient=function(){
	this._EndPoint="https://app.omie.com.br/api/v1/produtos/formaspagvendas/";
	...
	this.ListarFormasPagVendas=function(
		venparListarRequest,
		_cb
	){
		return this._Call(
...
module.exports = FormasPagVendasJsonClient;